...
MODEL_NAME=yolov8m.pt  # Medium - 精准
```
...
- [Handler 模式](/zh/architecture/handlers) — 模型实现方式
- [REST API](/zh/api/rest-api) — API 用法
